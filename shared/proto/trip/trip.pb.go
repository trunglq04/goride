...
func (x *CancelTripResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_trip_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"trip.proto\x12\x04trip\"D\n" +
	"\x12CancelTripResponse\x12\x16\n" +
	"\x06tripID\x18\x01 \x01(\tR\x06tripID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"[\n" +
	"\x11CancelTripRequest\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x16\n" +
	"\x06tripID\x18\x02 \x01(\tR\x06tripID\x12\x16\n" +
	...
	"\x11totalPriceInCents\x18\x04 \x01(\x01R\x11totalPriceInCents2\xd3\x01\n" +
	"\vTripService\x12B\n" +
	"\vPreviewTrip\x12\x18.trip.PreviewTripRequest\x1a\x19.trip.PreviewTripResponse\x12?\n" +
	"\n" +
	"CreateTrip\x12\x17.trip.CreateTripRequest\x1a\x18.trip.CreateTripResponse\x12?\n" +
	"\n" +
	"CancelTrip\x12\x17.trip.CancelTripRequest\x1a\x18.trip.CancelTripResponseB\x18Z\x16shared/proto/trip;tripb\x06proto3"
...
var file_trip_proto_goTypes = []any{
	(*CancelTripResponse)(nil),  // 0: trip.CancelTripResponse
	(*CancelTripRequest)(nil),   // 1: trip.CancelTripRequest
	...
	(*Trip)(nil),                // 6: trip.Trip
	(*TripDriver)(nil),          // 7: trip.TripDriver
	(*Coordinate)(nil),          // 8: trip.Coordinate
	(*Geometry)(nil),            // 9: trip.Geometry
	(*Route)(nil),               // 10: trip.Route
	(*RideFare)(nil),            // 11: trip.RideFare
}
var file_trip_proto_depIdxs = []int32{
	8,  // 0: trip.PreviewTripRequest.startLocation:type_name -> trip.Coordinate
	8,  // 1: trip.PreviewTripRequest.endLocation:type_name -> trip.Coordinate
	10, // 2: trip.PreviewTripResponse.route:type_name -> trip.Route
	11, // 3: trip.PreviewTripResponse.rideFares:type_name -> trip.RideFare
	6,  // 4: trip.CreateTripResponse.trip:type_name -> trip.Trip
	11, // 5: trip.Trip.selectedFare:type_name -> trip.RideFare
	10, // 6: trip.Trip.route:type_name -> trip.Route
	7,  // 7: trip.Trip.driver:type_name -> trip.TripDriver
	8,  // 8: trip.Geometry.coordinates:type_name -> trip.Coordinate
	9,  // 9: trip.Route.geometry:type_name -> trip.Geometry
	2,  // 10: trip.TripService.PreviewTrip:input_type -> trip.PreviewTripRequest
	4,  // 11: trip.TripService.CreateTrip:input_type -> trip.CreateTripRequest
	1,  // 12: trip.TripService.CancelTrip:input_type -> trip.CancelTripRequest
	3,  // 13: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
	5,  // 14: trip.TripService.CreateTrip:output_type -> trip.CreateTripResponse
	0,  // 15: trip.TripService.CancelTrip:output_type -> trip.CancelTripResponse
