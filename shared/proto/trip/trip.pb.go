...
var file_trip_proto_goTypes = []any{
	...
	(*TripDriver)(nil),          // 5: trip.TripDriver
	(*Coordinate)(nil),          // 6: trip.Coordinate
	(*Geometry)(nil),            // 7: trip.Geometry
	(*Route)(nil),               // 8: trip.Route
	(*RideFare)(nil),            // 9: trip.RideFare
}
var file_trip_proto_depIdxs = []int32{
	6,  // 0: trip.PreviewTripRequest.startLocation:type_name -> trip.Coordinate
	6,  // 1: trip.PreviewTripRequest.endLocation:type_name -> trip.Coordinate
	8,  // 2: trip.PreviewTripResponse.route:type_name -> trip.Route
	9,  // 3: trip.PreviewTripResponse.rideFares:type_name -> trip.RideFare
	4,  // 4: trip.CreateTripResponse.trip:type_name -> trip.Trip
	9,  // 5: trip.Trip.selectedFare:type_name -> trip.RideFare
	8,  // 6: trip.Trip.route:type_name -> trip.Route
	5,  // 7: trip.Trip.driver:type_name -> trip.TripDriver
	6,  // 8: trip.Geometry.coordinates:type_name -> trip.Coordinate
	7,  // 9: trip.Route.geometry:type_name -> trip.Geometry
	0,  // 10: trip.TripService.PreviewTrip:input_type -> trip.PreviewTripRequest
	2,  // 11: trip.TripService.CreateTrip:input_type -> trip.CreateTripRequest
	1,  // 12: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
	3,  // 13: trip.TripService.CreateTrip:output_type -> trip.CreateTripResponse
